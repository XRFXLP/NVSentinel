...
func (c *platformConnectorClient) HealthEventOccuredV1(ctx context.Context, in *HealthEvents, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PlatformConnector_HealthEventOccuredV1_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPlatformConnectorServer must be embedded to have forward compatible implementations.
