...
{{/*
Fabric env vars — reads from fabricProfiles[networkFabric].env.
*/}}
{{- define "preflight.fabric.env" -}}
{{- if and .Values.networkFabric (hasKey .Values.fabricProfiles .Values.networkFabric) }}
{{- $profile := index .Values.fabricProfiles .Values.networkFabric }}
{{- if $profile.env }}
{{- toYaml $profile.env }}
{{- end }}
{{- end }}
...
{{/*
Fabric extraHostPathMounts — reads from fabricProfiles[networkFabric].
*/}}
{{- define "preflight.fabric.extraHostPathMounts" -}}
{{- if and .Values.networkFabric (hasKey .Values.fabricProfiles .Values.networkFabric) }}
{{- $profile := index .Values.fabricProfiles .Values.networkFabric }}
{{- if $profile.extraHostPathMounts }}
{{- toYaml $profile.extraHostPathMounts }}
{{- end }}
{{- end }}
{{- end }}

{{/*
Fabric extraVolumeMounts — reads from fabricProfiles[networkFabric].
*/}}
{{- define "preflight.fabric.extraVolumeMounts" -}}
{{- if and .Values.networkFabric (hasKey .Values.fabricProfiles .Values.networkFabric) }}
{{- $profile := index .Values.fabricProfiles .Values.networkFabric }}
{{- if $profile.extraVolumeMounts }}
{{- toYaml $profile.extraVolumeMounts }}
{{- end }}
{{- end }}
{{- end }}

{{/*
Fabric ncclTopoConfigMap — returns the ConfigMap name (only for IB fabric).
*/}}
{{- define "preflight.fabric.ncclTopoConfigMap" -}}
{{- if eq (.Values.networkFabric | default "") "ib" }}
