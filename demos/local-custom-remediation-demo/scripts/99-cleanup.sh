...
main() {
    section "Cleaning Up Custom Remediation Demo"
    ...
    docker rmi -f memory-pressure-monitor:demo 2>/dev/null || true
    docker rmi -f memory-reclaim-controller:demo 2>/dev/null || true
