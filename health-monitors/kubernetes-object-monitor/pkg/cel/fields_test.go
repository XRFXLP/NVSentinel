...
func TestResourceFieldPaths(t *testing.T) {
	tests := []struct {
		name       string
		expression string
		want       []string
...
func TestResourceFieldPathsIgnoresShadowedResourceBinding(t *testing.T) {
	env, err := NewCompilerEnvironment()
	require.NoError(t, err)
...
func TestResourceFieldPathsRejectsNilAST(t *testing.T) {
